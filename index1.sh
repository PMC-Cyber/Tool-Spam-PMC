...
echo -e "${BL}╠════╦════════════════════════════════╣"        "${BL}╠════╦════════════════════════════════╣"
echo -e "${BL}║\e[32m[\e[33mS1\e[32m]${BL}║${W}  SPAM SMS                      ${BL}║ ${BL}║\e[32m[\e[33mT1\e[32m]${BL}║${W} ꦟꦸꦩ꧀ꦨꦺꦂꦮ꧀ꦲꦡ꧀ꦯPP꧀                  ${BL}║"
echo -e "${BL}║\e[32m[\e[33mS2\e[32m]${BL}║${W}  SPAM CALL V2                  ${BL}║ ${BL}║\e[32m[\e[33mT2\e[32m]${BL}║${W} ꦗꦺꦴꦅꦟ꧀ꦓꦿꦸꦦ꧀ꦮ꧀ꦲꦡ꧀ꦯPP꧀               ${BL}║"
echo -e "${BL}║\e[32m[\e[33mS3\e[32m]${BL}║${W}  SPAM CALL V1                  ${BL}║ ${BL}║\e[32m[\e[33mT3\e[32m]${BL}║${W} ꦗꦺꦴꦅꦟ꧀ꦓꦿꦸꦦ꧀ꦡꦺꦭꦺꦓꦿꦩ꧀              ${BL}║"
echo -e "${BL}║\e[32m[\e[33mS4\e[32m]${BL}║${W}  SPAM WA UNLIMITED             ${BL}║ ${BL}║\e[32m[\e[33mT4\e[32m]${BL}║${W} ꦓꦶꦛꦸꦨ꧀ꦄꦢ꧀ꦩꦶꦟ꧀                 ${BL}║"
echo -e "${BL}║\e[32m[\e[33mS5\e[32m]${BL}║${W}  VIRUS SPAM PHONE              ${BL}║ ${BL}║\e[32m[\e[33mT5\e[32m]${BL}║${W} ꦮꦺꦨ꧀ꦯꦶꦡꦺꦄꦢ꧀ꦩꦶꦟ꧀                 ${BL}║"
echo -e "${BL}╚════╩════════════════════════════════╝ ╚════╩════════════════════════════════╝"
echo -e "${BL}                      ╔══════════════════════════════════╗"
echo -e "${BL}                      ║         ${R}SOFTWARE FOR HACK        ${BL}║"
echo -e "${BL}                      ╠════╦═════════════════════════════╣"
